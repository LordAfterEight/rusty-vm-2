...
impl Logging {
    ...
    pub fn process(&self) {
        for msg in self.msg_queue.iter() {
            ...
            match msg {
                Message::Info(s) => print!("\x1b[38;2;100;150;255m"),
                Message::Debug(s) => print!("\x1b[38;2;255;200;50m"),
                Message::Warn(s) => print!("\x1b[38;2;255;100;50m"),
                Message::Error(s) => print!("\x1b[38;2;255;50;50m")
            }
            print!("{}", msg);
            print!("\x1b[0m\n");
        }
